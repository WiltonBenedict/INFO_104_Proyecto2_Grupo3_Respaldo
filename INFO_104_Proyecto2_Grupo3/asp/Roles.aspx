<%@ Page Title="" Language="C#" MasterPageFile="~/menuCuenta.Master" AutoEventWireup="true" CodeBehind="Roles.aspx.cs" Inherits="INFO_104_Proyecto2_Grupo3.asp.Roles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <h1 class="auto-style3">CATALOGO ROLES</h1>
    </div>
    ...
    <div>
        <table class="w-50" align="center">
            ...
            <tr>
                ...
                <td class="auto-style2"><asp:TextBox ID="tDescripcion" runat="server"></asp:TextBox></td>
            </tr>
        </table>
    </div>
