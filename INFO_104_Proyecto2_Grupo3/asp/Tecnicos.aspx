<%@ Page Title="" Language="C#" MasterPageFile="~/menuPersonal.Master" AutoEventWireup="true" CodeBehind="Tecnicos.aspx.cs" Inherits="INFO_104_Proyecto2_Grupo3.asp.Tecnicos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <h1 class="auto-style3">CATALOGO TECNICOS</h1>
    </div>
    ...
    <div>
        <table class="w-50" align="center">
            ...
            <tr>
                ...
                <td class="auto-style2"><asp:TextBox ID="tEspecialidad" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
